...
# !!! Main.UserApp is configured as an alias for Main.CryptoTracker and you might encounter it in some tests
using Main.CryptoTracker, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "CryptoTracker tests" begin
  @includetests ARGS
end
